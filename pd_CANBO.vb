...
Public Class pd_CANBO
    ...
    Public Sub Delete(ByVal arrpr() As SqlParameter)
        pr.ExeCuteprocedure("ps_T_CanBo_Delete", arrpr)

    End Sub
    Public Sub Update(ByVal arrpr() As SqlParameter)
        pr.ExeCuteprocedure("ps_T_CanBo_Update", arrpr)
    ...
    End Function
    Public Function getMaDoi(ByVal arrpr() As SqlParameter) As DataTable
